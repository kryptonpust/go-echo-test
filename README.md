[![Build Status](https://app.travis-ci.com/kryptonpust/go-echo-test.svg?branch=main)](https://app.travis-ci.com/kryptonpust/go-echo-test)
[![codecov](https://codecov.io/gh/kryptonpust/go-echo-test/branch/main/graph/badge.svg?token=hxaHIVyoBN)](https://codecov.io/gh/kryptonpust/go-echo-test)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/kryptonpust/go-echo-test/blob/master/LICENSE)
[![Go Reference](https://pkg.go.dev/badge/github.com/kryptonpust/go-echo-test.svg)](https://pkg.go.dev/github.com/kryptonpust/go-echo-test)
[![GoReportCard Badge](https://goreportcard.com/badge/github.com/kryptonpust/go-echo-test)](https://goreportcard.com/report/github.com/kryptonpust/go-echo-test)
[![Total alerts](https://img.shields.io/lgtm/alerts/g/kryptonpust/go-echo-test.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/kryptonpust/go-echo-test/alerts/)
...
<!--toc-->
- [Echo REST API boilerplate](#go-echo-test-boilerplate)
...
> **DO NOT FORK** this is meant to be used from **[Use this template](https://github.com/kryptonpust/go-echo-test/generate)** feature.

1. Click on **[Use this template](https://github.com/kryptonpust/go-echo-test/generate)**
